...
public class EvaluationServiceIMPL implements IEvaluationService{
    ...
    public Evaluation updateEvaluation(Long id, Evaluation evaluation) {
        ...
        if (optionalEvaluation.isPresent()) {
           ...
           if (evaluation.getUserId() != null) {
                existingEvaluation.setUserId(evaluation.getUserId());
            }else {
                existingEvaluation.setUserId(null); // Or handle as appropriate if null should be explicitly set
            }
    ...
    public List<Evaluation> findByUserIdAndCompetenceIdAndEval(Long userId, Long competenceId, EvaluationType eval) {
        return evaluationRepository.findByUserIdAndCompetenceAndEval(userId, competenceId, eval);
    }

    @Override
    public List<Evaluation> findByUserIdAndCompetenceId(Long userId, Long competenceId) {
        return evaluationRepository.findByUserIdAndCompetence(userId, competenceId);
    }
    @Transactional
    @Override
    ...
    public Double calculateAndAssignAverageNote(Long userId, Long competenceId) {
        ...
        Optional<Evaluation> forUserEvaluationOpt = evaluationRepository.findByUserIdAndCompetenceAndEval(userId, competenceId, EvaluationType.FORUSER)
                .stream()
                .findFirst();
    ...
    public List<Evaluation> getEvaluationsByUserIdAndType(Long userId, String evalType) {
        return evaluationRepository.findByUserIdAndEval(userId, EvaluationType.valueOf(evalType));
    }
